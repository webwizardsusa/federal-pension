	...
	<div class="activity-item quiz">
		...
		<div class="content">
			...
			<?php if ( $course = $this->get_activity_course( $activity ) ) : ?>
				...
				?>
					</strong> <strong><a href="<?php echo esc_attr( Cast::to_string( get_permalink( $course->ID ) ) ); ?>" class="link"><?php the_title( $course->ID ); ?></a></strong>
					<?php
					edit_post_link(
						sprintf(
							// translators: placeholder: Title of current post
...
<?php if ( is_null( $activity->activity_type ) ) : ?>
	...
	<div class="activity-item not-started">
		...
		<div class="content">
			<?php if ( $course = $this->get_activity_course( $activity ) ) : ?>
				<?php // Translators: Course. ?>
				<strong><?php printf( esc_html_x( '%s:', 'Course:', 'learndash' ), esc_html( LearnDash_Custom_Label::get_label( 'course' ) ) ); ?></strong> <strong><a href="<?php echo esc_attr( Cast::to_string( get_permalink( $course->ID ) ) ); ?>" class="link"><?php the_title( $course->ID ); ?></a></strong>
									<?php
									edit_post_link(
										sprintf(
										// translators: placeholder: Title of current post
