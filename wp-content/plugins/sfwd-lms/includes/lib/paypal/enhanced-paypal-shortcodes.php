...
if ( ! function_exists( 'enhanced_paypal_shortcode' ) ) {
	...
	function enhanced_paypal_shortcode( $atts ) {
		...
		<input type="image" src="https://www.paypal.com/en_US/i/scr/pixel.gif" border="0" alt="" width="1" height="1" class="ppalholder">';
				...
				$code .= '<input type="submit" value="' . $button_text . '" class="btn-join button button-primary button-large wp-element-button' . ( $registration_variation !== $variation_classic ? ' ld--ignore-inline-css' : '' ) . '" id="btn-join">';
		...
		<input type="image" src="https://www.paypal.com/en_US/i/scr/pixel.gif" border="0" alt="" width="1" height="1">';
				...
				$code .= '<input type="submit" value="' . $button_text . '" class="btn-join' . ( $registration_variation !== $variation_classic ? ' ld--ignore-inline-css' : '' ) . '" id="btn-join">';
